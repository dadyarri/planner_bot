    ...
    private async Task OnCallbackQuery(CallbackQuery callbackQuery)
    {
        ...
        switch (split[0])
        {
            ...
            case CallbackActions.VoteCancel:
                {
                    await HandleVoteCancelCallback(callbackQuery, split);
                    break;
                }
            ...
            case CallbackActions.CampaignJoinPick:
                {
                    await HandleCampaignJoinPickCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.CampaignJoinToggle:
                {
                    await HandleCampaignJoinToggleCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.CampaignJoinPage:
                {
                    await HandleCampaignJoinPageCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.CampaignJoinSave:
                {
                    await HandleCampaignJoinSaveCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.CampaignJoinCancel:
                {
                    await HandleCampaignJoinCancelCallback(callbackQuery, split);
                    break;
                }
            ...
            case CallbackActions.VotePickCampaign:
                {
                    await HandleVotePickCampaignCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.VotePickSlot:
                {
                    await HandleVotePickSlotCallback(callbackQuery, split);
                    break;
                }
            case CallbackActions.VoteConfirm:
                {
                    await HandleVoteConfirmCallback(callbackQuery, split);
                    break;
                }
            ...
            case CallbackActions.VoteCampaignPick:
                {
                    await HandleVoteCampaignPickCallback(callbackQuery, split);
                    break;
                }
